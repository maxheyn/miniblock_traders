...
kill @e[type=item,nbt={Item:{tag:{tag:mt_alchemist}}},distance=..0.5]
...
data merge entity @s {VillagerData:{profession:nitwit,level:5,type:plains},PersistenceRequired:1,CustomName:"\"PLACEHOLDER_NAME\"",\
    Offers: {\
        Recipes: [\
        {\
            maxUses: 999999,\
